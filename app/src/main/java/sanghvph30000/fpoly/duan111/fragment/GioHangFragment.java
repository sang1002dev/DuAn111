...
import sanghvph30000.fpoly.duan111.Adapter.GioHangAdapter;
import sanghvph30000.fpoly.duan111.Adapter.HoaDonAdapter;
import sanghvph30000.fpoly.duan111.DAO.DAOGioHang;
import sanghvph30000.fpoly.duan111.DAO.DAOHoaDon;
...
import sanghvph30000.fpoly.duan111.Model.HoaDon;
...
//        EditText edname = view.findViewById(R.id.edtGHTenKH);
...
//                    Settext cho các View
                    ...
                    HoaDonAdapter adapterHoaDon = new HoaDonAdapter(getContext(), listGioHang);
...
//                            Tạo Model HoaDon, Thêm vào bảng Lưu Hóa đơn
                            HoaDon hoaDon = new HoaDon(maUser, fullName, ngayTaoHD, 1);
...
//                                    Lưu hóa đơn thành công -> Xóa thông tin giỏ hàng, hóa đơn
    ...
    private void createData() {
        ...
        if (listGioHang.size() == 0) {
            ...
            GioHangAdapter adapterGioHang = new GioHangAdapter(getContext(), listGioHang);
